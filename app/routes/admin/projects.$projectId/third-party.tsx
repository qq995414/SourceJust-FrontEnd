...
export default function Index() {
  ...
  return (
    <div className="flex flex-col py-6 px-32">
      <div className="flex place-content-between">
        ...
        <Button
          className="self-center border-0 shadow-md"
          type="deactivated"
          onClick={() => {
            setIsShowLink(true);
          }}
        ...
        {isShowLink &&
          ...
          rounded-xl shadow-xl flex flex-col pt-12">
              <p className="font-semibold text-xl self-center">新增項目</p>
              <div className="flex-grow mx-8 mt-3">
                <div className="flex items-center my-6">
                  <div className="w-28 text-lg">第三方廠商</div>
                  <div className="flex-grow h-14">
                    <Select<number>
                      className="bg-gray-100 text-black h-14 relative"
                      value = {target}
                      onChange={setTarget}
                      options= {[
                        {
                ...
                <div className="flex items-center my-6">
                  <div className="w-28 text-lg">網站</div>
                  <div
                    className="place-content-center items-center text-blue-500
                  flex-grow border-2 border-gray-200 rounded-md flex h-14">
                    <div>http://www.網站連結</div>
                  </div>
                </div>
              </div>
              <div className="flex place-content-around mb-10">
                <Button
                  ...
                  className="w-32 text-sm font-medium h-12"
                >取消</Button>
                <Button
                  onClick={() => {
                    setIsShowLink(false);
