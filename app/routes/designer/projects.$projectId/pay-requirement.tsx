      ...
      <div className="mt-12 w-full">
        ...
        <div className="flex w-full h-16 items-center border-b-[1px]">
          ...
          <div className="w-48 text-center">
            <button
              className="w-20 h-10 text-center text-white bg-[#99CB98]
        ...
        <div className="flex w-full h-16 items-center border-b-[1px]">
          ...
          <div className="w-48 text-center">
            <button
              className="w-24 h-10 text-center text-white bg-[#BBBBBB] rounded-full
            shadow-lg">
              尚未付款</button>
          </div>
        </div>
        <div className="flex w-full h-16 items-center">
          <p className="w-36 text-center">40%</p>
          <p className="w-40 text-center">$ 40,000</p>
          <p className="w-72 text-center">2022/1/22</p>
          <p className="w-40 text-center"></p>
          <div className="w-48 text-center">
            <button
              className="w-24 h-10 text-center text-white bg-[#BBBBBB]
