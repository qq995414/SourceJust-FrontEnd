...
h-12 rounded-lg ml-3  font-semibold "
      ...
      <Nav titleGray='' title="洽談列表" titleBlack=""></Nav>
                  ...
                  if (i == true) {
                    return <div className='flex  table-list-checked table-list w-full'>
                      <div className={select === true ? 'flex  table-list-checked table-list w-full pt-2' : 'table-list flex w-full pt-2'}>
                        ...
                        <div className='w-2/12 flex-row  pt-3 items-center'>
                          <div className='w-12/12 pb-1'>
                            <Link
                              className='negotiate-button px-2'
                              to="/business/record"
                              prefetch="intent"
                            >
                              <a>查看洽談紀錄</a></Link>                          </div>
                          <div className='w-12/12'>
                            <button className='negotiate-button'>新增洽談紀錄</button>
                          </div>
                        </div>
                        <div className='w-1/12 pl-2 pr-2  flex items-center'>
                          <Link
                            className='w-4/12 mx-1 mt-2'
                            to="/business/record"
                            prefetch="intent"
                          >
                            <img
                    ...
                    return <div className='table-list flex w-full'>
                      <div className={select === true ? 'flex  table-list-checked table-list w-full pt-2 pb-2' : 'table-list flex w-full pt-2 pb-2'}>
                        ...
                        <div className='w-2/12 flex-row items-center'>
                          <div className='w-12/12 pb-1'>
                            <Link
                              to="/business/record"
                              prefetch="intent"
                            >
                                <button className='negotiate-button'>查看洽談紀錄</button></Link>
                          </div>
                          <div className='w-12/12'>
                            <button className='negotiate-button'>新增洽談紀錄</button>
                          </div>
