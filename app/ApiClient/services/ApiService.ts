...
import type { ResponseListChannelResponse } from '../models/ResponseListChannelResponse';
...
export class ApiService {
    ...
    public uploadFileInfo(
        fileType: 'UI' | 'DATA' | 'CONTRACT' | 'DEV_TEST' | 'PROD_TEST',
        projectId: number,
        title?: string,
        remark?: string,
        requestBody?: {
    ...
    /**
     * 全部欄目
     * @returns ResponseListChannelResponse OK
     * @throws ApiError
     */
    public listChannel(): CancelablePromise<ResponseListChannelResponse> {
        return this.httpRequest.request({
            method: 'GET',
